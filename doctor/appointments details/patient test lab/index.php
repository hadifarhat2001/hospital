 ...
 .body-container {
  ...
  <body>
    ...
    <div class="table-header">
              <button class="btn add-LabTest" onclick="openAddLabTestModal()">
                Add New LabTest
              </button>
            </div>
            <table>
    ...
    <script>
      function openAddLabTestModal() {
            var modal = document.getElementById("addLabTestModal");
          ...
          document.getElementById("addLabTestForm").addEventListener("submit", function(event) {
            event.preventDefault();
            var formData = new FormData(this); 
            fetch("./add_patient_test.php", {
              method: "POST",
              body: formData
            })
